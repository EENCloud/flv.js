...
class FlvPlayer {
    ...
    constructor(mediaDataSource, config, mediaElement) {
        ...
        this.e = {
            ...
            onvVolumeChange: this._onvVolumeChange.bind(this)
        };
    ...
    attachMediaElement(mediaElement) {
        ...
        mediaElement.addEventListener('play', this.e.onvVolumeChange);
        mediaElement.addEventListener('pause', this.e.onvVolumeChange);
    ...
    detachMediaElement() {
        if (this._mediaElement) {
            ...
            this._mediaElement.removeEventListener('play', this.e.onvVolumeChange);
            this._mediaElement.removeEventListener('pause', this.e.onvVolumeChange);
            this._mediaElement = null;
        }
        if (this._msectl) {
