...
class FLVDemuxer {
    ...
    _parseULawAudioData(arrayBuffer, dataOffset, dataSize, tagTimestamp) {
        let exp_lut = [0, 132, 396, 924, 1980, 4092, 8316, 16764];
        ...
        for (let i=0; i<array.length; i++) {
            ...
            // //if (i < 5)
            // //    console.log("Sample: " + outputArray[i])
            // let val = ~array[i];
            //
    ...
    _parseAudioData(arrayBuffer, dataOffset, dataSize, tagTimestamp) {
        ...
        if (false && this._hasAudioFlagOverrided === true && this._hasAudio === false) {
        ...
        if (soundFormat === 10) {  // AAC
            ...
            let dts = this._timestampBase + tagTimestamp;
            let pcm_sample = {unit: raw_pcm, length: raw_pcm.byteLength, dts: dts, pts: dts};
            this._audio.enqueue(raw_pcm, dts)
            //track.samples.push(pcm_sample);
            //track.length += pcm_sample.length;
        }
    }
